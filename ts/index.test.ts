...
test(
	...
	async () => {
		...
		assert.equal(typeof steamApi.ugc.setItemDescription, 'function');
		...
		assert.equal(typeof steamApi.ugc.getItemUpdateProgress, 'function');
		assert.equal(typeof steamApi.ugc.setUserItemVote, 'function');
		...
		assert.equal(typeof steamApi.ugc.getSubscribedItems, 'function');
		assert.equal(typeof steamApi.ugc.getItemDownloadInfo, 'function');
		assert.equal(typeof steamApi.ugc.downloadItem, 'function');
		assert.equal(typeof steamApi.ugc.download, 'function');
		...
		assert.equal(typeof steamApi.ItemUpdateStatus.Invalid, 'number');
		assert.equal(typeof steamApi.ItemPreviewType.Image, 'number');
